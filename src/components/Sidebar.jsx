...
function NavItem({ icon: Icon, label, count, active, disabled, onClick, shortcut }) {
  return (
    <button
      ...
      disabled={disabled}
      className={cn(
        'group flex h-8 w-full items-center gap-2.5 rounded-xl px-2.5 text-[13px] transition-colors',
        active
...
export default function Sidebar({
  ...
  return (
    <aside className="glass-panel hidden h-full w-60 shrink-0 flex-col rounded-2xl md:flex">
      {/* Workspace header */}
